                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control choices form-select choices__input" data-choice="active" name="" id="BotagatyProduct">
                                        @foreach ($BotagatyProduct as $Product )
                                        <option value="{{$Product->product_code}}">{{$Product->name->ar}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
